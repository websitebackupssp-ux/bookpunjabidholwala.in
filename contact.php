      ...
      <div class="row">
        <div class="col-lg-6 mb-30">
          <div class="contact-box">
            ...
            <p class="contact-box__text">C-640, Block C, New Friends Colony,
            ...
            <div class="contact-box__item">
              ...
              <div class="media-body">
                ...
                <p class="contact-box__info"><a href="tel:917042662430">+91 7042662430</a><a
                    href="mailto:rajdhol2552@gmail.com">rajdhol2552@gmail.com</a></p>
              </div>
            </div>
            <div class="contact-box__item">
              ...
              <div class="media-body">
                ...
                <p class="contact-box__info">C-640, Block C, New Friends Colony,
                  New Delhi, Delhi 110065</p>
              </div>
            </div>
            <div class="contact-box__item">
              ...
              <div class="media-body">
                ...
                <p class="contact-box__info">7:00am - 10:00pm ( Mon - Sat ) Sun &amp; Holiday
                  Closed</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 mb-30">
          <div class="contact-box">
            ...
            <form class="contact-box__form " action="wmail.php" method="POST">
              <div class="row gx-20">
