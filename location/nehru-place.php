    ...
    <div class="container z-index-common">
        <div class="breadcumb-content">
            <div class="breadcumb-title">
                <h1 style="color: #f1f1f1;">Dhol Player Services in Nehru Place</h1>
                <p style="color: #f1f1f1;">Book Punjabi Dhol Wala offers energetic and professional Punjabi dhol services in Nehru Place — perfect for weddings, parties, and cultural celebrations.</p>
            </div>
        ...
        <div class="row justify-content-between align-items-end">
            <div class="col-lg-6">
                <div class="title-area">
                    ...
                    <h2 class="sec-title">Get A New Experience With Us</h2>
                </div>
            </div>
        ...
        <div class="row vs-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" id="service-slider1">
            ...
            <div class="col-lg-3">
                <div class="service-style2" data-bg-src="../assets/images/g-2.webp">
                    ...
                    <a href="../service" class="vs-btn">View More<i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="service-style2" data-bg-src="../assets/images/g-5.webp">
                    ...
                    <a href="../service" class="vs-btn">Read More<i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3">
